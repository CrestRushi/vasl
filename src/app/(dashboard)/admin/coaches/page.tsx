...
import { setCoaches, addCoach, removeCoach } from "@/store/slices/coachSlice";
...
export default function AdminCoachesPage() {
  ...
  const coaches = useAppSelector((s) => s.coach.list);
  ...
  useEffect(() => {
    if (!coaches.length) {
      coachService.list().then((c) => dispatch(setCoaches(c)));
    }
  }, [coaches.length, dispatch]);
                ...
                <tr key={c.id} className="group">
                  ...
                  <td className="border-b border-[rgba(60,50,40,0.08)] px-[22px] py-[13px] group-hover:bg-[#EDE7DC]">
                    ...
                    <Button
                      ...
                      onClick={() => dispatch(removeCoach(c.id))}
                    >
                      Remove
                    </Button>
                  </td>
